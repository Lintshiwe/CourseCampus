      ...
      <Tabs defaultValue="analytics">
        ...
        <TabsContent value="materials">
          <Card>
            ...
            <CardContent>
                {loading.materials ? <LoadingSkeleton /> : (
                   <Table><TableHeader><TableRow><TableHead>Title</TableHead><TableHead>File</TableHead><TableHead>Course</TableHead><TableHead>Type</TableHead><TableHead>Downloads</TableHead><TableHead className="text-right">Actions</TableHead></TableRow></TableHeader>
                    <TableBody>
